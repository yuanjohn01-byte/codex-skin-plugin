...
- Prepare the next immutable Staging-only candidate: Helper `.11` and Bootstrap `.10`.
  Existing Plugin launcher pins remain on the verified `.10/.9` closure until the
