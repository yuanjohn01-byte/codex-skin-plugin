...
const bootstrapFilename = "codex-skin-bootstrap_0.1.0-paid-alpha.8_windows_x64.exe"
...
func fixtureProcess() {
	...
	if strings.HasPrefix(name, "codex-skin-bootstrap_") {
		...
		fmt.Println(`{"type":"result","protocolVersion":1,"ok":true,"status":"completed","data":{"helperVersion":"0.1.0-paid-alpha.9"},"error":null}`)
		return
	}
