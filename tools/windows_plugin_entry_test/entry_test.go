...
const bootstrapFilename = "codex-skin-bootstrap_0.1.0-paid-alpha.9_windows_x64.exe"
...
func fixtureProcess() {
	...
	if strings.HasPrefix(name, "codex-skin-bootstrap_") {
		...
		fmt.Println(`{"type":"result","protocolVersion":1,"ok":true,"status":"completed","data":{"helperVersion":"0.1.0-paid-alpha.10"},"error":null}`)
		return
	}
