...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="codex-skin-attestation-") as temporary:
        ...
        launcher = plugin / "scripts" / ".bootstrap" / "codex-skin-bootstrap_0.1.0-paid-alpha.6_macos_arm64"
        ...
        helper_name = "codex-skin-helper_0.1.0-paid-alpha.7_macos_arm64"
        helper = application / "bin" / "0.1.0-paid-alpha.7" / helper_name
            ...
            + json.dumps(
                {
                    ...
                    "data": {
                        "command": "version",
                        "helperVersion": "0.1.0-paid-alpha.7",
                        "pluginVersion": "0.1.0-paid-alpha",
                        "helperReleaseTag": "helper-v0.1.0-paid-alpha.7",
